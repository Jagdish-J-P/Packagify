...
namespace Jagdish_J_P\EmailVerifier\Helpers;
use Exception;
...
class EmailHelper {
    ...
    public function verify($email) {
        ...
        switch ($code) {
            case '503':
                return 2; // some email server dont allow we check email (example: yahoo.com)
                break;
            case '250':
            /**
            ...
            default :
                return 0;
            // we have 3 return, 0 => fail, 1 => success, 2 => server dont allow, 3 => server can't connect
        }
    }
